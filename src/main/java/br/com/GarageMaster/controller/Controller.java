...
@WebServlet(urlPatterns = { "/Controller", "/authenticationFilter", "/client", "/funcionario", "/veiculo", "/peca",
		"/service", "/relationService", "/clientsVeiculo", "/serviceForm", "/venda", "/vendaForm", "/relationVenda", "/addClient", "/addFuncionario", "/addVeiculo", "/addPeca",
		"/addService", "/addRelationService", "/addVenda", "/addRelationVenda", "/selectClient", "/updateClient", "/selectFuncionario", "/updateFuncionario", "/selectVeiculo",
		"/updateVeiculo", "/selectPeca", "/updatePeca", "/selectService", "/updateService", "/selectVenda","/updateVenda", "/deleteClient",
		"/deleteFuncionario", "/deleteVeiculo", "/deletePeca", "/deleteService", "/deleteRelationService", "/deleteVenda", "/deleteRelationVenda"})
public class Controller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		} else if (action.equals("/addVenda")) {
